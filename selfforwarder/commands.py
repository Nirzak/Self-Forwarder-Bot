...
from selfforwarder import dbwrapper
from selfforwarder import keyboards
from selfforwarder import messages
...
def help_command(update, context):
    ...
    update.message.reply_text(text=text, parse_mode=ParseMode.HTML, reply_markup="")
